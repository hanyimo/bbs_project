        ...
        <div class="widget">
            <table cellpadding="0" cellspacing="0" border="0" class="display dTable">
            	...
            	<c:forEach items="${invitations }" var="invitation">
            		<tr class="gradeA">
            			<td class="center">${invitation.userAlice }</td>
            			<td class="center"><a href="${pageContext.request.contextPath}/invitation_byid?invitationId=${invitation.invitationId }">${invitation.invitationTitle }</a></td>
            			<td class="center">
